...
<div class=table-responsive>
 ...
 <table class="table table-striped" >
         ...
         <a href="<?php echo site_url('Quotation/Quotationview');?>" style="background-color:#00A157 ;margin:0px !important;" type="button" class="btn bg-olive margin">View Quotations</a>
              </div>
        <!-- /.col (left) -->
        <div class="col-md-6">
...
$('input[name=nettotal]').val(nettotal);
 ...
 var damnt=$('input[name=damnt]');
       ...
       var result = '';
        ...
        if(qty.val()==''){
          qty.attr('style','border:1px solid #864545!important');
      }
           else{
        qty.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      }
       ...
       if(description.val()==''){
       description.attr('style','border:1px solid #864545!important');
      }
           else{
         description.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      }

 if(unit.val()==''){
           unit.attr('style','border:1px solid #864545!important');
      }
           else{
         unit.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } if(rate.val()==''){
         rate.attr('style','border:1px solid #864545!important');
      }
           else{
         rate.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } 
      if(discount.val()==''){
       discount.attr('style','border:1px solid #864545!important');
      }
           else{
         discount.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      }
...
var result='';
if(subtotal.val()==''){
        subtotal.attr('style','border:1px solid #864545!important');
      }
           else{
       subtotal.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } 

if(advance_perc.val()==''){
   advance_perc.attr('style','border:1px solid #864545!important');
      }
           else{
          advance_perc.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } 

      if(totaldamnt.val()==''){
           totaldamnt.attr('style','border:1px solid #864545!important');
      }
           else{
        totaldamnt.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } 
      if(nettotal.val()==''){
          nettotal.attr('style','border:1px solid #864545!important');
      }
           else{
       nettotal.removeAttr('style','border:1px solid #864545!important');
            result +='1';
      } 
      if(remarks.val()==''){
...
for(j=0;j<itemList.length;j++){
  if(itemList[j]!='' ){
       ...
       itemList[j].push(subtotal,totaldiscount,totaldamnt,nettotal,remarks,advance_perc,advance_amount,attention,delivery,payment_remarks,quotation_valid,subject); 
...
$('#show_data tr').remove();
   ...
   window.location.href= '<?php echo site_url("Quotation/printqt")?>';    
