    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">Add  Bank Payment Voucher</h3>
        </div>
...
if(itemList[m][0]==m){
if(itemList[m][2]>0){
   total=total-itemList[m][2];
    debit1=debit1-itemList[m][2];
     $('input[name=subtotal]').val(total);
     check();
}
else{
  total=total-(-1*itemList[m][3]);
...
$.ajax({
  ...
  dataType:'JSON',
  url:'<?php echo site_url('Voucher/add_bank_voucher')?>',
  success:function(){
    $('#myForm')[0].reset();
    $('#show_data tr').remove();
 showvoucher();
