...
Receipt Voucher
 ...
 <table class="table table-striped" >
        ...
        <button style="background-color:#00A157;margin:0px !important;" type="button" class="btn bg-olive margin" id=print  >Save and Print</button>
...
$('#print').click(function(){
 $.ajax({
  ...
  dataType:'JSON',
  url:'<?php echo site_url('Voucher/add_receipt_voucher')?>',
  async:false,
  success:function(){
   $.ajax({
  type:'POST',
  ...
  dataType:'JSON',
  url:'<?php echo site_url('Voucher/add_to_session1')?>',
  async:false,
  success:function(){
 ...
 window.location.href="<?php echo site_url('Voucher/add_receipt_print')?>";
