<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View Payment Reports</li>
      </ol>
    </section>
...
url:'<?php echo site_url('Reports/show_payment_report')?>',
datatype:'json',
...
type:'post',
data:{'array':array},
url:'<?php echo site_url('Reports/report1')?>',
datatype:'json',
success:function(){
...
$('#print').attr('href','<?php echo site_url('Reports/print_payment_report')?>');
