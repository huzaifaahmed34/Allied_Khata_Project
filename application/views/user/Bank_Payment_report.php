    ...
    <section class="content">
      ...
      <div class="box box-success">
        <div class="box-header with-border">
          <h3 class="box-title">Bank Payment Report</h3>
        </div>
                  ...
                  <tr>
                    <Td></Td>
                     ...
                     <td style="background: #36688d;color:white;"><b>Debit: </b> <span id=debit></span> </td>
                            <td style="background: #36688d;color:white;"><b>Credit : </b> <span id=total></span> </td> 
             </tr>
            </table>
            </div>
<div class=col-xs-10>
...
url:'<?php echo site_url('Reports/show_bank_payment_report')?>',
datatype:'json',
...
$.each(res,function(i,item){
  ...
  sno++;
if(item.amount>0){
   html+='<tr><td>'+sno+'</td><td>'+res[i].date+'</td><td>'+res[i].fullname+'</td><td>'+res[i].remarks+'</td><td>'+res[i].amount+'</td><td>'+0+'</td></tr>';
...
type:'post',
data:{'array':array},
url:'<?php echo site_url('Reports/report4')?>',
datatype:'json',
success:function(){
...
$('#print').attr('href','<?php echo site_url('Reports/bank_payment_report_print')?>');
